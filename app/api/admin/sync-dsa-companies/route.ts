 ...
 * our problems by LeetCode slug) onto production rows, adds any new
 * topics/patterns the new problems need, and inserts the new problems
 * that rank in a real company's top-25 list but weren't in our set yet.
 * Existing rows only get their companyTags UPDATEd — status/notes/
