...
export const DSA_PROBLEMS: ProblemSeed[] = [
  // Arrays (7)
  { title: "Two Sum", platform: "LeetCode", url: LC("two-sum"), difficulty: "Easy", topic: "Arrays", pattern: "Two Pointers", companyTags: ["Google", "Amazon", "Meta"] },
  { title: "Best Time to Buy and Sell Stock", platform: "LeetCode", url: LC("best-time-to-buy-and-sell-stock"), difficulty: "Easy", topic: "Arrays", pattern: "Two Pointers", companyTags: ["Amazon", "Microsoft"] },
  { title: "Product of Array Except Self", platform: "LeetCode", url: LC("product-of-array-except-self"), difficulty: "Medium", topic: "Arrays", pattern: "Prefix Sum", companyTags: ["Amazon", "Meta", "Apple"] },
  ...
  // Strings (7)
  { title: "Valid Anagram", platform: "LeetCode", url: LC("valid-anagram"), difficulty: "Easy", topic: "Strings", pattern: "Sliding Window", companyTags: ["Amazon"] },
  { title: "Longest Substring Without Repeating Characters", platform: "LeetCode", url: LC("longest-substring-without-repeating-characters"), difficulty: "Medium", topic: "Strings", pattern: "Sliding Window", companyTags: ["Amazon", "Meta", "Bloomberg"] },
  ...
  { title: "Group Anagrams", platform: "LeetCode", url: LC("group-anagrams"), difficulty: "Medium", topic: "Strings", pattern: "Sliding Window", companyTags: ["Amazon", "Uber"] },
  { title: "Valid Parentheses", platform: "LeetCode", url: LC("valid-parentheses"), difficulty: "Easy", topic: "Strings", pattern: "Monotonic Stack", companyTags: ["Google", "Amazon", "Microsoft"] },
  ...
  { title: "String to Integer (atoi)", platform: "LeetCode", url: LC("string-to-integer-atoi"), difficulty: "Medium", topic: "Strings", pattern: "Two Pointers", companyTags: ["Amazon", "Microsoft"] },

  // Linked Lists (6)
  { title: "Reverse Linked List", platform: "LeetCode", url: LC("reverse-linked-list"), difficulty: "Easy", topic: "Linked Lists", pattern: "Two Pointers", companyTags: ["Amazon", "Microsoft", "Apple"] },
  ...
  { title: "Merge Two Sorted Lists", platform: "LeetCode", url: LC("merge-two-sorted-lists"), difficulty: "Easy", topic: "Linked Lists", pattern: "Two Pointers", companyTags: ["Amazon", "Microsoft", "LinkedIn"] },
  ...
  // Trees (8)
  { title: "Maximum Depth of Binary Tree", platform: "LeetCode", url: LC("maximum-depth-of-binary-tree"), difficulty: "Easy", topic: "Trees", pattern: "DFS", companyTags: ["Amazon", "Google"] },
  ...
  { title: "Binary Tree Level Order Traversal", platform: "LeetCode", url: LC("binary-tree-level-order-traversal"), difficulty: "Medium", topic: "Trees", pattern: "BFS", companyTags: ["Amazon", "Microsoft", "Meta"] },
  ...
  { title: "Serialize and Deserialize Binary Tree", platform: "LeetCode", url: LC("serialize-and-deserialize-binary-tree"), difficulty: "Hard", topic: "Trees", pattern: "BFS", companyTags: ["Google", "Meta", "Microsoft"] },

  // Graphs (7)
  { title: "Number of Islands", platform: "LeetCode", url: LC("number-of-islands"), difficulty: "Medium", topic: "Graphs", pattern: "DFS", companyTags: ["Amazon", "Google", "Microsoft"] },
  { title: "Clone Graph", platform: "LeetCode", url: LC("clone-graph"), difficulty: "Medium", topic: "Graphs", pattern: "DFS", companyTags: ["Amazon", "Meta"] },
  { title: "Course Schedule", platform: "LeetCode", url: LC("course-schedule"), difficulty: "Medium", topic: "Graphs", pattern: "DFS", companyTags: ["Amazon", "Google", "Bloomberg"] },
  ...
  { title: "Word Ladder", platform: "LeetCode", url: LC("word-ladder"), difficulty: "Hard", topic: "Graphs", pattern: "BFS", companyTags: ["Amazon", "Meta", "LinkedIn"] },

  // Heaps (6)
  { title: "Kth Largest Element in an Array", platform: "LeetCode", url: LC("kth-largest-element-in-an-array"), difficulty: "Medium", topic: "Heaps", pattern: "Top-K / Heap", companyTags: ["Amazon", "Microsoft"] },
  { title: "Top K Frequent Elements", platform: "LeetCode", url: LC("top-k-frequent-elements"), difficulty: "Medium", topic: "Heaps", pattern: "Top-K / Heap", companyTags: ["Amazon", "Meta"] },
  { title: "Find Median from Data Stream", platform: "LeetCode", url: LC("find-median-from-data-stream"), difficulty: "Hard", topic: "Heaps", pattern: "Top-K / Heap", companyTags: ["Google", "Amazon"] },
  { title: "Merge K Sorted Lists", platform: "LeetCode", url: LC("merge-k-sorted-lists"), difficulty: "Hard", topic: "Heaps", pattern: "Top-K / Heap", companyTags: ["Amazon", "Google", "Meta"] },
  { title: "Task Scheduler", platform: "LeetCode", url: LC("task-scheduler"), difficulty: "Medium", topic: "Heaps", pattern: "Greedy", companyTags: ["Amazon", "Meta"] },
  ...
  // Binary Search (6)
  { title: "Binary Search", platform: "LeetCode", url: LC("binary-search"), difficulty: "Easy", topic: "Binary Search", pattern: "Binary Search", companyTags: ["Google", "Amazon"] },
  { title: "Search in Rotated Sorted Array", platform: "LeetCode", url: LC("search-in-rotated-sorted-array"), difficulty: "Medium", topic: "Binary Search", pattern: "Binary Search", companyTags: ["Amazon", "Microsoft", "Meta"] },
  ...
  { title: "Longest Increasing Subsequence", platform: "LeetCode", url: LC("longest-increasing-subsequence"), difficulty: "Medium", topic: "Dynamic Programming", pattern: "Dynamic Programming", companyTags: ["Microsoft", "Google"] },
  ...
  { title: "Word Break", platform: "LeetCode", url: LC("word-break"), difficulty: "Medium", topic: "Dynamic Programming", pattern: "Dynamic Programming", companyTags: ["Amazon", "Meta", "Bloomberg"] },
  ...
  { title: "Longest Common Subsequence", platform: "LeetCode", url: LC("longest-common-subsequence"), difficulty: "Medium", topic: "Dynamic Programming", pattern: "Dynamic Programming", companyTags: ["Amazon", "Microsoft"] },
  ...
  // Intervals (6)
  { title: "Merge Intervals", platform: "LeetCode", url: LC("merge-intervals"), difficulty: "Medium", topic: "Intervals", pattern: "Greedy", companyTags: ["Amazon", "Google", "Meta"] },
  { title: "Insert Interval", platform: "LeetCode", url: LC("insert-interval"), difficulty: "Medium", topic: "Intervals", pattern: "Greedy", companyTags: ["Google", "Amazon"] },
  ...
  { title: "Meeting Rooms", platform: "LeetCode", url: LC("meeting-rooms"), difficulty: "Easy", topic: "Intervals", pattern: "Greedy", companyTags: ["Meta", "Amazon"] },
  { title: "Meeting Rooms II", platform: "LeetCode", url: LC("meeting-rooms-ii"), difficulty: "Medium", topic: "Intervals", pattern: "Top-K / Heap", companyTags: ["Meta", "Amazon", "Google"] },
  ...
  // Backtracking (6)
  { title: "Subsets", platform: "LeetCode", url: LC("subsets"), difficulty: "Medium", topic: "Backtracking", pattern: "Backtracking", companyTags: ["Amazon", "Meta"] },
  ...
  { title: "Permutations", platform: "LeetCode", url: LC("permutations"), difficulty: "Medium", topic: "Backtracking", pattern: "Backtracking", companyTags: ["Amazon", "Microsoft"] },
